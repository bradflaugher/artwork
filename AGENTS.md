...
- **Loop 8 ship (iteration 2 verify):** mm/loop-7 — structural/theme checks pass on `the-stars-keep-a-separate-calendar.md`; index link count **27** matches README; PR #8 open. Mission complete; skip re-implement. Never stage `fix_plan.md`.
